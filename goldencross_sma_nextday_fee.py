...
# Introduce negotiation fee
fee = 0.001  # Example fee of 0.1%
data['Strategy Return'] = data['Daily Return'] * data['Position'] - fee * data['Operation'].abs()
...
# Number of trades
num_trades = data['Operation'].abs().sum()
